...
from gfg_004_rotate_array import rotate_array_1, rotate_array_2, rotate_array_3
...
def test_rotate_array_3(arr: list[int], d: int, expected: list[int]) -> None:
    """
    Test.
    """
    assert rotate_array_3(arr, d) == expected
